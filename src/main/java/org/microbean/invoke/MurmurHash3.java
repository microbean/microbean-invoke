...
/**
 * An implementation of the public-domain <a href="https://github.com/aappleby/smhasher/blob/master/src/MurmurHash3.cpp"
 * target="_parent">MurmurHash3</a> hashing algorithm, copied mostly verbatim <a
 * href="https://github.com/yonik/java_util/blob/master/src/util/hash/MurmurHash3.java" target="_parent">as written and
 * also placed into the public domain by Yonik Seeley</a>.
 *
 * <p>Slight deviations from Seeley's code include only the addition of various {@link SuppressWarnings} annotations,
 * formatting changes, and the like.</p>
 *
 * <p>Seeley's comments follow:</p>
 *
...
final class MurmurHash3 {
  ...
  public static final long getLongLittleEndian(final byte[] buf, final int offset) {
  ...
  public static final int murmurhash3_x86_32(final byte[] data, final int offset, final int len, final int seed) {
   ...
   * of String.getBytes().
   */
  public static final int murmurhash3_x86_32(final CharSequence data, final int offset, final int len, final int seed) {
  ...
  @SuppressWarnings("fallthrough")
  public static final void murmurhash3_x64_128(final byte[] key, final int offset, final int len, final int seed, final LongPair out) {
